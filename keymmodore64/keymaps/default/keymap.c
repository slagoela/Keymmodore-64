...
#define AG(kc)  ALGR(kc) // AltGr combo 


const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
[PC] = LAYOUT(
    KC_GESC,                        KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,    KC_EQL,     KC_INS,     KC_HOME,    KC_DEL,     KC_F1,          KC_P7,  KC_P8,  KC_P9,   \
    CTL_T(KC_TAB),                  KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,    KC_RBRC,    KC_PGUP,    KC_BSPC,                KC_F3,          KC_P4,  KC_P5,  KC_P6,   \
    KC_LALT,                        KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,    KC_NUHS,    KC_ENT,                             KC_F5,          KC_P1,  KC_P2,  KC_P3,   \
    MO(CKEY),   LM(LSHFT,MOD_LSFT), KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    MO(RSHFT),              KC_DOWN,    KC_RGHT,                KC_F7,                  KC_P0,  KC_PDOT, \
                                                                                    KC_SPC
                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                 \
[LSHFT] = LAYOUT(
    ____,                           ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       KC_F2,          ____,   ____,   ____,    \
    ____,                           ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,                   KC_F4,          ____,   ____,   ____,    \
    ____,                           ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,                               KC_F6,          ____,   ____,   ____,    \
    KC_NO,      ____,               ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,                   ____,       ____,                   KC_F8,                  ____,   ____,    \
                                                                                    ____
    ),
                                                                                                                                                                                                                                                                 \
[RSHFT] = LAYOUT(
    ____,                           AG(KC_1),   AG(KC_2),   AG(KC_3),   AG(KC_4),   AG(KC_5),   AG(KC_6),   AG(KC_7),   AG(KC_8),   AG(KC_9),   AG(KC_0),   AG(KC_MINS),AG(KC_EQL), ____,       S(KC_HOME), S(KC_DEL),  KC_F2,          ____,   ____,   ____,    \
    ____,                           AG(KC_Q),   AG(KC_W),   AG(KC_E),   AG(KC_R),   AG(KC_T),   AG(KC_Y),   AG(KC_U),   AG(KC_I),   AG(KC_O),   AG(KC_P),   AG(KC_LBRC),AG(KC_RBRC),____,       S(KC_BSPC),             KC_F4,          ____,   ____,   ____,    \
    ____,                           AG(KC_A),   AG(KC_S),   AG(KC_D),   AG(KC_F),   AG(KC_G),   AG(KC_H),   AG(KC_J),   AG(KC_K),   AG(KC_L),   AG(KC_SCLN),AG(KC_QUOT),AG(KC_NUHS),____,                               KC_F6,          ____,   ____,   ____,    \
    KC_NO,      ____,               AG(KC_Z),   AG(KC_X),   AG(KC_C),   AG(KC_V),   AG(KC_B),   AG(KC_N),   AG(KC_M),   KC_NUBS,    S(KC_NUBS), AG(KC_SLSH),____,                   KC_UP,      KC_LEFT,                KC_F8,                  ____,   ____,    \
                                                                                    ____
    ),
                                                                                                                                                                                                                                                                 \
[CKEY] = LAYOUT(
    ...
    KC_LCTRL,                       KC_PGUP,    KC_UP,      KC_PGDN,    ____,       ____,       ____,       KC_PGUP,    KC_UP,      KC_PGDN,    KC_PSCR,    KC_SLCK,    KC_NLCK,    KC_PGUP,    KC_PGDN,                TO(C128),       ____,   ____,   ____,    \
...
[C64] = LAYOUT(
    ...
    KC_TAB,                         KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,    KC_RBRC,    KC_DEL,     KC_PGUP,                KC_F3,          ____,   ____,   ____,    \
...
[C128] = LAYOUT(
    ...
    LM(CBM,MOD_LCTL),   KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    MO(C128_RSFT),          KC_DOWN,    KC_RGHT,                KC_F7,                  ____,   ____,    \
                                                                                    KC_SPC
                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                 \
[C128_RSFT] = LAYOUT(
    KC_PAST,                        KC_P1,      KC_P2,      KC_P3,      KC_P4,      ____,       KC_P6,      KC_P7,      KC_P8,      KC_P9,      KC_P0,      KC_PPLS,    KC_PMNS,    S(KC_INS),  S(KC_HOME), S(KC_BSPC), KC_F2,          ____,   ____,   ____,    \
    KC_F11,                         S(KC_Q),    S(KC_W),    S(KC_E),    S(KC_R),    S(KC_T),    S(KC_Y),    S(KC_U),    S(KC_I),    S(KC_O),    S(KC_P),    KC_LCBR,    KC_RCBR,    KC_F10,     S(KC_PGUP),             KC_F4,          ____,   ____,   ____,    \
...
[PETGRAPH] = LAYOUT(
    ...
    KC_INS,                         KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,    KC_RBRC,    KC_DEL,     KC_BSPC,                KC_NO,          ____,   ____,   ____,    \
...
[PETGRAPH_C] = LAYOUT(
    ...
    TO(PC),                         S(KC_F10),  S(KC_3),    S(KC_1),    S(KC_2),    S(KC_F3),   S(KC_7),    S(KC_8),    S(KC_F2),   S(KC_9),    KC_QUES,    S(KC_F4),   KC_TILD,    S(KC_DEL),  ____,                   ____,           ____,   ____,   ____,    \
...
[PETBUS] = LAYOUT(
    KC_GRV,                         KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,    KC_EQL,     KC_INS,     KC_HOME,    KC_BSPC,    KC_F1,          ____,   ____,   ____,    \
    KC_TAB,                         KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,    KC_RBRC,    KC_DEL,     KC_BSPC,                KC_F3,          ____,   ____,   ____,    \
    KC_ESC,                         KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,    KC_BSLS,    KC_ENT,                             KC_F5,          ____,   ____,   ____,    \
    MO(PETBUS_C),       KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,                KC_DOWN,    KC_RGHT,                KC_F7,                  ____,   ____,    \
                                                                                    KC_SPC
                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                 \
[PETBUS_C] = LAYOUT(
    KC_NO,                          KC_P1,      KC_P2,      KC_P3,      KC_P4,      ____,       KC_P6,      KC_P7,      KC_P8,      KC_P9,      KC_P0,      KC_NO,      KC_NO,      KC_NO,      ____,       KC_NO,      KC_NO,          ____,   ____,   ____,    \
    TO(PC),                         KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      ____,                   KC_NO,          ____,   ____,   ____,    \
...
[CBM] = LAYOUT(
    ...
    TO(PC),                         ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,       ____,                   ____,           ____,   ____,   ____,    \
